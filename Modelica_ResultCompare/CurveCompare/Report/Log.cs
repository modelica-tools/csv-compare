...
namespace CurveCompare
{
    public sealed class Log : IDisposable
    {
        ...
        {
            if (_logFileInfo == null || String.IsNullOrWhiteSpace(_logFileInfo.FullName))
                return;
        ...
        {
            if (level < _verbosity || _logFileInfo == null || String.IsNullOrWhiteSpace(_logFileInfo.FullName))
                return;
